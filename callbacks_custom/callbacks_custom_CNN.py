...
class metrics(keras.callbacks.Callback):
    ...
    def on_train_end(self, logs={}):
        ...
        if os.path.isdir('./variables_cnn'):
            pass
        else:
            os.mkdir('./variables_cnn')

        pickle.dump(self.loss, open('./variables_cnn/Loss_proxsgd', 'wb'))
        pickle.dump(self.acc, open('./variables_cnn/Accuracy_proxsgd', 'wb'))
        pickle.dump(self.loss_train, open('./variables_cnn/Loss_proxsgd_train', 'wb'))
        pickle.dump(self.acc_train, open('./variables_cnn/Accuracy_proxsgd_train', 'wb'))
        pickle.dump(self.l1, open('./variables_cnn/NormL1_proxsgd', 'wb'))
        pickle.dump(self.w_net, open('./variables_cnn/Weights_proxsgd', 'wb'))
        return
    ...
    def on_epoch_end(self, epoch, logs={}):
        ...
        self.w_net.append(w)
        b_net.append(b)
        w, b = self.model.get_layer('conv2').get_weights()
        self.w_net.append(w)
        b_net.append(b)
        w, b = self.model.get_layer('conv3').get_weights()
        self.w_net.append(w)
        b_net.append(b)
        w, b = self.model.get_layer('conv4').get_weights()
        self.w_net.append(w)
        b_net.append(b)
        w, b = self.model.get_layer('conv5').get_weights()
        self.w_net.append(w)
        b_net.append(b)
        w, b = self.model.get_layer('conv6').get_weights()
        self.w_net.append(w)
        b_net.append(b)
        w, b = self.model.get_layer('fc1').get_weights()
        self.w_net.append(w)
        b_net.append(b)
        l1_norm = 0
